          ...
          <div>
            ...
            <Reveal delay={300}>
              <div className="mt-10 grid grid-cols-3 gap-2 border-t border-border pt-8">
                {[["Advanced Tech", "Digital scans"], ["Fellowship-Trained", "Expert surgical team"], ["Pain-Free Care", "Gentle protocols"]].map(([t, l]) => (
                  <div key={t}>
